...
* WordPress 6.0.1 or greater (Tested up to: 6.7)
* WooCommerce 6.7.0 or greater (Tested up to: 9.3.3)
...
* [CityPay Paylink WooCommerce Plugin 2.1.4](https://github.com/citypay/citypay-paylink-woo-commerce)
